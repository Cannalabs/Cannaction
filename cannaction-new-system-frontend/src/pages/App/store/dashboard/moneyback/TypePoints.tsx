...
import MoneyBackIllustration from '../../../../../assets/img/illustrations/moneyback.svg';
...
export const TypePoints: React.FC<Props> = ({ data, requestPrize }) => {
